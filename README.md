...
- Cross-lingual embedding (LASER or LaBSE) similarity between target language documents and those same documents back-translated into English (or adjacent high-resource language) and translated using the proposed framework
